...
MODEL_PATH = os.path.join(THIS_DIR, "phish_model_logreg_combined_cv.joblib")
...
def main():
    ...
    print(f"[INFO] LogReg best params: {search.best_params_}")
    print(f"[INFO] LogReg best CV F1: {search.best_score_:.4f}")
